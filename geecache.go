...
import (
	"fmt"
	pb "github.com/huangxinzhong/GeeCache/geecachepb"
	"github.com/huangxinzhong/GeeCache/singleflight"
	"log"
	"sync"
)
...
func (g *Group) RegisterPeers(peers PeerPicker) {
	if g.peers != nil {
		panic("RegisterPeerPicker called mopre than once")
	}
	...
	viewi, err := g.loader.Do(key, func() (interface{}, error) {
		if g.peers != nil {
			if peer, ok := g.peers.PickPeer(key); ok {
				...
				log.Println("[GeeCache] ailed to get form peer ", err)
			}
		}
